package com.steffbeard.totalwar.npc.builder;
...
import com.steffbeard.totalwar.npc.builder.BuilderTrait.BuildPatternsXZ;
import com.steffbeard.totalwar.npc.builder.BuilderTrait.BuilderState;
import com.steffbeard.totalwar.npc.utils.BuilderUtils;
...
public class Builder extends JavaPlugin {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String cmdLabel, String[] inargs) {
		...
		if (args[0].equalsIgnoreCase("help")) {
			...
			for (int j = 1; j < 137; j++) {
				sb.append( j+":"+ BuilderUtils.getLocalItemName(j) +" > " +  (net.minecraft.server.v1_6_R1.Block.byId[j].getDropType(j, BuilderUtils.R,-10000)) +":" + BuilderUtils.getLocalItemName(net.minecraft.server.v1_6_R1.Block.byId[j].getDropType(j, BuilderUtils.R,-10000))+ "\n" );
			}
		...
		if (args[0].equalsIgnoreCase("build")) {
			...
			inst.BuildYLayers = 1;
			inst.BuildPatternXY = com.steffbeard.totalwar.npc.builder.BuilderTrait.BuildPatternsXZ.spiral;			
			for (int a = 0; a< args.length; a++){
				if (args[a].toLowerCase().contains("oncomplete:")){
					...
					inst.BuildPatternXY = com.steffbeard.totalwar.npc.builder.BuilderTrait.BuildPatternsXZ.reversespiral;
				}
				else if (args[a].equalsIgnoreCase("linear")){
					inst.BuildPatternXY = com.steffbeard.totalwar.npc.builder.BuilderTrait.BuildPatternsXZ.linear;
				}
				else if (args[a].equalsIgnoreCase("reverselinear")){
					inst.BuildPatternXY = com.steffbeard.totalwar.npc.builder.BuilderTrait.BuildPatternsXZ.reverselinear;
				}
			...
			if (args.length <= 1) {
				...
				if(args[1].equalsIgnoreCase("clear")){
					...
					if(inst.State == com.steffbeard.totalwar.npc.builder.BuilderTrait.BuilderState.building){
			...
			if (inst.State != com.steffbeard.totalwar.npc.builder.BuilderTrait.BuilderState.idle) {
